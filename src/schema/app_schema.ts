...
export type Group = ProxyNode<typeof group>;
export type Note = ProxyNode<typeof note>;
export type Notes = ProxyNode<typeof notes>;
export type Items = ProxyNode<typeof items>;
